...
class SearchGroups extends React.Component {
  ...
  query = () => {
    fetch(`https://www.bungie.net/Platform/GroupV2/User/${this.props.match.params.membershipType}/${this.props.match.params.membershipId}/0/1/`, {
      headers: {
          ...
          <div className='results'>
            <ul className='list'>
              {this.state.results.map(result => (
                <li className='linked' key={result.group.groupId}>
                  <Link
                    to={{
