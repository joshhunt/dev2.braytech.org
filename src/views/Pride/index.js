      ...
      <div className='view' id='pride'>
        <div className='message'>
          ...
          <div className='description'>
            ...
            <p>I play games online, like Destiny, with a clan because it's fun to play together. I shouldn't need to remind my online friends that's I'm gay and that you're hurting my feelings when you use derogatory terms.</p>
